// GENERATED AUTOMATICALLY FROM 'Assets/Scripts/Player/OverworldInput.inputactions'
...
public class @OverworldInput : IInputActionCollection, IDisposable
{
    ...
    public struct OverworldActions
    {
        ...
        public OverworldActions(@OverworldInput wrapper) { m_Wrapper = wrapper; }
